...
class TestSuspenseConfigImmutable(EhReconcileIntegrationTestCase):
    ...
    def setUpClass(cls):
        ...
        cls.suspense_account = cls._ensure_account(cls.env, '1991', 'Reclass Suspense', 'asset_current')
    ...
    def _make_open_suspense_line(self, amount):
        ...
        line = move.line_ids.filtered(lambda l: l.account_id == self.suspense_account)
    ...
    def test_reclass_on_non_reconcilable_account_raises_and_keeps_config(self):
        ...
        with self.assertRaises(UserError):
            session._post_reclassification_entry(open_suspense, self.account_expense, 'Reclass')
    ...
    def test_reclass_on_reconcilable_account_still_posts(self):
        ...
        adjusting = session._post_reclassification_entry(open_suspense, self.account_expense, 'Reclass')
        ...
        self.assertIn(self.account_expense, adjusting.line_ids.mapped('account_id'))
